    ...
    <main className="min-h-screen bg-white font-sans text-gray-900 selection:bg-blue-100">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link 
                ...
                className={`text-sm font-bold flex items-center gap-1 ${
                  isScrolled ? 'text-indigo-600' : 'text-indigo-200 hover:text-white'
                }`}
            >
                AI Planner ✨
            </Link>
          ...
          <div className="hidden md:block">
            {isLoggedIn ? (
              <Link 
                ...
                className={`px-5 py-2.5 rounded-full text-sm font-bold transition shadow-lg ${
                    isScrolled 
              ...
              <Link 
                href="/login"
                className={`px-6 py-2.5 rounded-full text-sm font-bold transition shadow-lg ${
                    isScrolled 
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { id: 101, name: "Goa, India", price: "₹18,500", img: "https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?w=800", type: "Beach" },
            { id: 102, name: "Manali, India", price: "₹12,999", img: "https://images.unsplash.com/photo-1626621341517-bbf3d9990a23?w=800", type: "Mountain" },
            { id: 103, name: "Jaipur, India", price: "₹9,500", img: "https://images.unsplash.com/photo-1477587458883-47145ed94245?w=800", type: "City" }
          ].map((dest) => (
            <Link key={dest.id} href={`/destinations`} className="group relative rounded-3xl overflow-hidden cursor-pointer shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 block h-96">
              <img src={dest.img} alt={dest.name} className="w-full h-full object-cover transition duration-700 group-hover:scale-110" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-8">
                <div className="transform translate-y-2 group-hover:translate-y-0 transition duration-300">
                    ...
                    <p className="text-gray-300 text-sm mb-4">Starting from <span className="text-white font-bold text-lg">{dest.price}</span></p>
